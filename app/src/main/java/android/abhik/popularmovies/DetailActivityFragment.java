...
public class DetailActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Movie movie = (Movie)getActivity().getIntent().getSerializableExtra(Movie.class.getName());
        ...
        ((TextView)v.findViewById(R.id.movie_rating)).setText(getString(R.string.title_rating)+" "+movie.getVote_average().toString());
        Picasso
